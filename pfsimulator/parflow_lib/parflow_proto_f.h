...
#define CALL_CLM_LSM(pressure_data, saturation_data, evap_trans_data, mask, porosity_data, \
                     ...
                     qflx_infl_data, swe_out_data, can_out_data, t_grnd_data, t_soil_data, \
...
void CLM_LSM(double *pressure_data, double *saturation_data, double *evap_trans_data, double *mask, double *porosity_data,
             ...
             double *qflx_infl_data, double *swe_out_data, double *can_out_data, double *t_grnd_data, double *t_soil_data, int *clm_dump_interval, int *clm_1d_out,
